...
#define BSE_MAC  DF(_MAC)
#define BSE_WIN  DF(_WIN)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      _______,  KC_DEL, KC_BSPC, XXXXXXX, XXXXXXX,  RGBRST,                      XXXXXXX, KC_HOME, KC_PGDN, KC_PGUP,  KC_END, _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, XXXXXXX,                      XXXXXXX, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, XXXXXXX,                      KC_MPLY, KC_MPRV, KC_MNXT, KC_VOLD, KC_VOLU, _______,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
...
void render_logo(void) {
    ...
    oled_write_P(PSTR("GSW"), false);
}

void render_layer_state(void) {
    static const char PROGMEM mac_layer[] = {
        0x20, 0x94, 0x95, 0x96, 0x20,
        0x20, 0xb4, 0xb5, 0xb6, 0x20,
        0x20, 0xd4, 0xd5, 0xd6, 0x20, 0};
    static const char PROGMEM win_layer[] = {
        0x21, 0x94, 0x95, 0x96, 0x20,
        0x21, 0xb4, 0xb5, 0xb6, 0x20,
        0x21, 0xd4, 0xd5, 0xd6, 0x20, 0};
    ...
    } else if(layer_state_is(_WIN)) {
        oled_write_P(win_layer, false);
    } else {
        oled_write_P(mac_layer, false);
    }
}
